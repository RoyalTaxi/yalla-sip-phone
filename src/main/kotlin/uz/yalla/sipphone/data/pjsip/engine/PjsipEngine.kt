package uz.yalla.sipphone.data.pjsip.engine
...
import uz.yalla.sipphone.data.pjsip.call.AudioMediaProvider
import uz.yalla.sipphone.data.pjsip.call.PjsipCallManager
import uz.yalla.sipphone.data.pjsip.account.PjsipAccountManager
...
class PjsipEngine : SipStackLifecycle, CallEngine {
    ...
    init {
        accountManager.incomingCallHandler = callManager::handleIncomingCall
    }
